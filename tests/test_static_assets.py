...
class TestStaticJSLibraries:
    ...
    def test_static_js_directory_exists(self):
        ...
        static_dir = Path(__file__).parent.parent / "diagram_renderer" / "renderers" / "static" / "js"
    ...
    def test_mermaid_js_file_exists(self):
        ...
        mermaid_file = Path(__file__).parent.parent / "diagram_renderer" / "renderers" / "static" / "js" / "mermaid.min.js"
    ...
    def test_static_assets_in_html_output(self):
        ...
        for diagram_type, code in test_cases:
            ...
            assert len(script_content) > 10_000, f"{diagram_type} HTML has insufficient script content"
