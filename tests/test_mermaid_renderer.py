...
class TestMermaidRenderer:
    ...
    def test_render_html_with_js(self, mermaid_renderer, sample_mermaid_flowchart, static_js_exists):
    ...
    def test_render_svg_html_without_js(self, mermaid_renderer, sample_mermaid_flowchart, monkeypatch):
...
class TestMermaidRendererIntegration:
    ...
    def test_end_to_end_flowchart(self, mermaid_renderer, sample_mermaid_flowchart):
        ...
        with unittest.mock.patch.object(mermaid_renderer, 'get_static_js_content', return_value="// mock"):
