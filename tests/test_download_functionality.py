...
class TestDownloadFunctionality:
    ...
    def test_error_messages_user_friendly(self):
        ...
        assert len(found_messages) > 0, "No user-friendly error messages found in HTML"
...
@enduml"""
    ...
    def test_both_download_buttons_present(self):
        ...
        for code in test_cases:
            ...
            )  # Accept various download icons, f"PNG download button missing for: {code[:20]}..."
...
class TestDownloadIntegration:
    ...
    def test_no_javascript_errors_in_basic_html(self):
        ...
        assert brace_diff <= 4, (
            f"Too many unbalanced JavaScript braces: {open_braces} vs {close_braces}"
        )
